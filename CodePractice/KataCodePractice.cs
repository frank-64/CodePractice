...
{
    public static class KataCodePractice
    {
        public static string FiveStringReverse(string sentence)
        {
        ...
        {
            List<string> elements = Elements.Keys.Select(key => key.ToLower()).ToList();
